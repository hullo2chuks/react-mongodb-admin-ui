# React-Redux-Flask with MongoDB Admin UI#

Starter application for a Flask JWT Backend with Mongodb and a React/Redux Front-End Admin UIs.
...
* SCSS processing
* Webpack
* MongoDB with MongoKat Framework
